...
<form id="form_edit_Data" action="edit/update/update_product.php" method="POST"> <!-- enctype="multipart/form-data" -->
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="product_id" id="product_id" value="<?php echo $result['product_id'] ?>" placeholder="Auto Increment" readonly>
    </div>
    <div class="mb-3">
        <label for="product_name" class="col-form-label">Product Name:</label>
        <input type="text" class="form-control" name="product_name" id="product_name" value="<?php echo $result['product_name'] ?>">
    </div>
    <div class="mb-3">
        <label for="price" class="col-form-label">Price:</label>
        <input type="text" class="form-control" name="price" id="price" value="<?php echo $result['price'] ?>">
    </div>
    <div class="mb-3">
        <label for="stock" class="col-form-label">Stock:</label>
        <input type="number" class="form-control" name="stock" id="stock" value="<?php echo $result['stock'] ?>">
    </div>
    <div class="mb-3">
        <label for="product_img" class="col-form-label">Product Image:</label>
        <input type="file" class="form-control" name="product_img" id="product_img" value="<?php echo $result['product_image'] ?>">
    </div>
    <div class="mb-3">
        <label for="description" class="col-form-label">Description:</label>
        <textarea class="form-control" name="description" id="description" cols="30" rows="5"><?php echo $result['description'] ?></textarea>
    </div>
    <div class="mb-3">
        <label for="date_add" class="col-form-label">Add Date:</label>
        <input type="datetime-local" class="form-control" name="date_add" id="date_add" value="<?php echo $result['date_add'] ?>">
    </div>
    <div class="mb-3">
        <label for="category_id" class="col-form-label">Category id:</label>
        <select class="form-select" name="category_id" id="category_id" value="<?php echo $result['category_id'] ?>">
            <option value=""></option>
